	...
	<script type="text/javascript">
		...
		function chatListFunction(type) {
			...
			$.ajax({
				...
				url: "./chatListServlet",
				data: {
					fromID: encodeURICompnent(fromID),
					toID: encodeURICompnent(toID),
					listType: type
				},
				success: function(data) {
					...
					lastID = Number(parsed.last); //ChatListServlet의 last에 해당하는 ID를 가져오는 것. 즉 가장 마지막으로 전달받은 ChatID를 가져오는 것.
				}
			});
		}
