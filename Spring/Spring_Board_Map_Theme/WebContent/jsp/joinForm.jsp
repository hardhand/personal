...
<body>
	...
	<center>
		<br> <br>
		<div class="container">
			<h1 style="text-align: center:">회원가입 화면</h1><br>
			<div class="col-lg-4" style="align: center"></div>
			<div class="col-lg-4">
				<div class="jumbotron" style="padding-top: 20px">
					<form method="post" action="join.do">
						...
						<div class="form-group">
							<input type="password" class="form-control"
								placeholder="비밀번호를 한번 더 입력하세요." name="pwd_CHECK" maxlength="20">
						</div>
						<div class="form-group">
