						...
						<form method="post" action="memberUpdate.do">
							...
							<div class="form-group">
								<input type="password" class="form-control"
									placeholder="비밀번호를 입력하세요." value="" name="pwd" maxlength="20">
							</div>
							<div class="form-group">
								<input type="password" class="form-control"
									placeholder="비밀번호를 한번 더 입력하세요." value="" name="pwd_CHECK"
									maxlength="20">
							</div>
							<div class="form-group">
								<input type="text" class="form-control" placeholder="이름"
									value="${name }" name="name" maxlength="20">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control" placeholder="연락처"
									value="${phone }" name="phone" maxlength="20">
							</div>
							<!-- 						<div class="form-group"> -->
							<!-- 							<input type="text" class="form-control" placeholder="관리자" -->
							<!-- 								name="admin" maxlength="20"> -->
							<!-- 						</div> -->
							<input type="reset" class="btn btn-warning form-control" value="다시입력"> 
